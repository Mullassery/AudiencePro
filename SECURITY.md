...
[private vulnerability reporting](https://github.com/Mullassery/ClusterAudienceKit/security/advisories/new)
rather than opening a public issue. We aim to acknowledge reports within a few days.

## Supported versions

ClusterAudienceKit v0.1+ receives security fixes. Patch releases are prioritized for vulnerabilities.
